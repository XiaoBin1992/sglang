...
class ModelConfig:
    ...
    def get_num_kv_head_ids(self, tensor_parallel_size, tensor_parallel_rank) -> int:
        heads_per_rank = self.get_num_kv_heads(tensor_parallel_size)
        return list(range((tensor_parallel_rank * heads_per_rank, (tensor_parallel_rank + 1) * heads_per_rank)))
